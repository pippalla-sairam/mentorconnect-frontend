...
const Signup = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-50 to-pink-50 p-4 sm:p-6 md:p-8">
            <div className="bg-white shadow-2xl rounded-2xl w-full max-w-4xl p-6 sm:p-8 border border-purple-100 transition duration-500">
                
                <div className="text-center mb-10">
                    <h1 className="text-4xl font-extrabold text-purple-700 mb-2">Join MentorConnect 🚀</h1>
                ...
                <form className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6" onSubmit={handleSubmit}>
                    ...
                    <div className="md:col-span-2">
                        ...
                        <input
                            ...
                            id="image"
                            onChange={handleChange}
                            className="w-full border border-gray-300 rounded-xl file:mr-4 file:py-3 file:px-4 file:rounded-xl file:border-0 file:text-sm file:font-bold file:bg-purple-50 file:text-purple-700 hover:file:bg-purple-100 transition cursor-pointer"
                            accept="image/*"
                        />
                    </div>
                    ...
                    {/* STUDENT-ONLY FIELDS */}
                    {userType === "student" && (
                        <div className="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6 pt-4 border-t border-purple-100">
                            <div>
                    ...
                    <div className="md:col-span-2 pt-6">
                        <button
                            type="submit"
                            className="w-full bg-purple-600 text-white py-3 rounded-xl font-bold text-lg hover:bg-purple-700 transition transform hover:scale-[1.005] shadow-xl shadow-purple-300/50"
                        >
                            Create Account
                        </button>
                    </div>
                ...
                <p className="text-center text-sm text-gray-600 mt-6">
                    ...
                    <a href="/login" className="text-purple-600 font-bold hover:text-purple-800 hover:underline transition">
                        Login here
                    </a>
                </p>
            </div>
